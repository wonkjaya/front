...
$siteTitle = 'Kios27'; /* will be displayed above the url-bar */
$siteName = 'KIOS27'; /* The biggest title on your homepage */
$siteDesc ='Kiosnya Orang Yang Gak Punya Lapak'; /*subtitle */
$siteTitleHome = 'Home'; // will be displayed above the url-bar when the home-page is open
$siteFooter = '©kios27.com';
